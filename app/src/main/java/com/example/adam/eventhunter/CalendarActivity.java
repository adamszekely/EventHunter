...
public class CalendarActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        eventArrayList.add(new EventActivity("Android Event","OCT 28","Horsens Campus",null));
        eventArrayList.add(new EventActivity("Adam EVENTOOO","OCT 28","Horsens Campus",null));
        eventArrayList.add(new EventActivity("Peters dentist","OCT 28","Horsens Campus",null));
